...
const queries = {
  ...
  citiesInNL:
    "SELECT City.Name AS Name from City, Country WHERE Country.Name = 'Netherlands' AND City.CountryCode = Country.Code",
  ...
  populationSum: 'SELECT SUM(Population) AS SUM FROM Country',
};
